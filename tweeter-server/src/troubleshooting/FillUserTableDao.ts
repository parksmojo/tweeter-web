...
export class FillUserTableDao {
  ...
  private readonly passwordAttribute = "password";
  ...
  private readonly followeeCountAttribute = "follows_count";
  private readonly followerCountAttribute = "followers_count";
  ...
  async increaseFollowersCount(alias: string, count: number): Promise<boolean> {
    const params = {
      ...
      UpdateExpression: "SET " + this.followerCountAttribute + " = :inc",
    };
