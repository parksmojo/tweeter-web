...
import { UserInfoPresenter, UserInfoView } from "../../presenters/userItemPresenters/UserInfoPresenter";
            ...
            <div className="col p-3">
              {displayedUser !== currentUser && (
                <p id="returnToLoggedInUser">
                  Return to{" "}
                  <Link to={""} onClick={(event) => presenter.switchToLoggedInUser(event, currentUser)}>
                    logged in user
                  </Link>
                </p>
              )}
